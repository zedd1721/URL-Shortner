  ...
  return (
    <div className="flex flex-col items-center px-3">
        ...
        <div className="flex flex-col md:flex-row items-center gap-6">
          <div>
            ...
            <p className="text-gray-600 text-lg">
              ShortyLink helps you turn long, ugly URLs into short, shareable links.<br />
              <span className="block mt-1 text-indigo-600 font-medium">
                No login needed for basic shortening.
              </span>
              <br />
              Keep your links clean and easy—whether for social media, business, or personal use!
            </p>
          </div>
          <img
            src={heroSvg}
      ...
      <div className="mt-16 max-w-4xl w-full">
        <h2 className="text-2xl font-bold text-indigo-700 text-center mb-6">How It Works</h2>
        <div className="flex flex-col md:flex-row items-center justify-center gap-8">
          ...
          <div className="flex flex-col items-center">
            <span className="text-4xl mb-2">📋</span>
            <span className="font-semibold">3. Copy & share your short link!</span>
          </div>
        </div>
      </div>
      ...
      <div className="mt-16 mb-10 max-w-4xl w-full">
        <h2 className="text-2xl font-bold text-indigo-700 text-center mb-6">Why ShortyLink?</h2>
        <div className="flex flex-col md:flex-row justify-center items-stretch gap-6">
          <div className="flex-1 bg-white rounded-xl shadow-lg p-6 text-center">
            ...
            <div className="text-gray-500">Shorten links instantly—no sign up or login required.</div>
          </div>
          <div className="flex-1 bg-white rounded-xl shadow-lg p-6 text-center">
            <div className="text-3xl mb-2">📈</div>
            <div className="font-bold mb-1">Track Your Links</div>
            <div className="text-gray-500">Sign up to manage, edit, or track your short links.</div>
          </div>
          <div className="flex-1 bg-white rounded-xl shadow-lg p-6 text-center">
            <div className="text-3xl mb-2">🛡️</div>
            <div className="font-bold mb-1">Safe & Reliable</div>
            <div className="text-gray-500">Your links are always secure and available.</div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-indigo-50 rounded-xl shadow-inner py-8 px-6 text-center max-w-3xl w-full mb-16">
        <div className="text-xl text-indigo-700 font-bold mb-2">Trusted by 1,000+ users</div>
        <div className="text-gray-500 mb-2">"Super easy and fast to use!"</div>
        <div className="text-gray-500 mb-2">"No login needed. Just what I wanted."</div>
      ...
      <footer className="w-full bg-white border-t py-6 mt-auto text-center text-gray-500">
        <div className="mb-2 flex items-center justify-center gap-2">
          <span>&copy; {new Date().getFullYear()} ShortyLink. All rights reserved.</span>
          <Link to="/" className="mx-2 hover:text-indigo-700">Home</Link>
          <Link to="/login" className="mx-2 hover:text-indigo-700">Login</Link>
          <Link to="/signup" className="mx-2 hover:text-indigo-700">Signup</Link>
        </div>
        <div className="flex justify-center gap-4 mt-2">
          <a href="#" className="hover:text-indigo-700 text-xl">🐦</a>
          <a href="#" className="hover:text-indigo-700 text-xl">💼</a>
          <a href="#" className="hover:text-indigo-700 text-xl">📧</a>
        </div>
      </footer>
